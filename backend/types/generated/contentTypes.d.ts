...
export interface ApiBillingBilling extends Struct.SingleTypeSchema {
...
export interface ApiBotBot extends Struct.SingleTypeSchema {
  collectionName: 'bots';
  info: {
    displayName: 'Bot';
    pluralName: 'bots';
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String;
    yk_customer_id: Schema.Attribute.String;
  };
}
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    interval: Schema.Attribute.Enumeration<['month']> &
    ...
    publishedAt: Schema.Attribute.DateTime;
    trial_amount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    trial_reminder_sent: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yk_last_payment_id: Schema.Attribute.String;
    yk_payment_method_id: Schema.Attribute.String;
  };
}
